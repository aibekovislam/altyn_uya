...
export default function Card({ firstPost }: any) {
  ...
  return (
    <div className={styles.card}>
        <Image src={`${firstPost.image}`} width={400} height={235} priority={true} alt={`Курбан алтын уя пожертвование - ${getMainTextByLanguage(firstPost, currentLanguage)}`} className={styles.card_img} title={`Курбан алтын уя пожертвование - ${getMainTextByLanguage(firstPost, currentLanguage)}`} />
